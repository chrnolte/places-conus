...
The `Estimation` component develops these estimates from data on private land transactions. Estimates are predictions made by :ref:`Models` that have been trained on sales of specific :ref:`Parcel types` in specific :ref:`Geographies` using different statistical :ref:`Estimators` and :ref:`Predictor sets`.
