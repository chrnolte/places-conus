...
Samples contain sales prices (:math:`y`) and :any:`Predictors` (:math:`X`).
...
* The :any:`type of sale <Sale types>`, which reflects our degree of confidence that the recorded price reveals something about a property's market value.
